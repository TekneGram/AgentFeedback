...
# def tokenize(llm: Llama, text: str) -> list[int]:
#     return llm.tokenize(
#         text.encode("utf-8"),
#         add_bos=True,
#         special=True
...
#     count = 0
#     buffer = ""
#     for token in llm.generate(tokens, reset=reset):
#         text = llm.detokenize([token]).decode("utf-8", errors="ignore")
#         buffer += text

#         if stop in buffer:
#             print(buffer.replace(stop, ""), end="", flush=True)
#             break
...
# def build_system_only(content_to_cache: str) -> str:
#     chat = format_chatml(
#         [
#             {"role": "system", "content": content_to_cache},
#         ]
#     )
#     return chat.prompt, chat.stop

# def build_user_only(task: str) -> str:
#     chat = format_chatml(
#         [
...
#     chat = format_chatml(
#         [
#             {"role": "system", "content": "You are complete idiot."},
...
#     # Cached system
#     # ----------
#     content = "Here is some writing: I went to Tokyo once. It was lovely. I really want to go there again. I wish my friends had come with me. I was lonely. I don't like being lonely. So I wanted to die. But I didn't. I was relieved. Thank you for reading. I had a lovely time."
#     system_prompt, _ = build_system_only(content)
#     system_tokens = tokenize(llm, system_prompt)

#     print("\n=== Caching system ===")
#     llm.eval(system_tokens)
#     system_length = len(system_tokens)

#     # ---------
#     # Multiple user tasks
#     # ---------
#     tasks = [
#         "As a kind teacher, give feedback on how interesting the writing above is.",
#         "As a critical reviewer, say what is wrong with the writing./no-think",
#         "As someone curious about language choice, ask questions about the writing./no-think"
#     ]

#     for i, task in enumerate(tasks, 1):
#         print(f"\n=== Analysis {i} ===")

#         # Reset KV cache back to *system only*
...
#         user_prompt, stop = build_user_only(task)
#         user_tokens = tokenize(llm, user_prompt)

#         t0 = time.perf_counter()
#         stream_tokens(llm, user_tokens, reset=False, stop=stop, max_tokens=256, seq_id=i)
